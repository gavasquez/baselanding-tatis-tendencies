      ...
      <div className=" sidebar-content">
        ...
        <SimpleBarReact style={ { height: "calc(100% - 70px)" } }>
          <ul className="sidebar-menu border-t border-white/10">
            ...
            <li>
              <Link href="/admin/redes-sociales" onClick={ ( e ) => { setSubManu( subManu === "/admin/redes-sociales" ? "" : "/admin/redes-sociales" ); } }><AiFillLike className="me-3 icon" />Redes Sociales</Link>
            </li>
            <li>
