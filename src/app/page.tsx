      ...
      <section className="py-36 md:py-30 w-full table relative bg-center bg-no-repeat bg-cover" style={ { backgroundImage: hero?.imageUrl ? `url(${ hero?.imageUrl })` : 'url("/uploads/bg-video.png")' } }>
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 text-center">
            <Image src={ siteSettings?.siteLogoUrl ? siteSettings?.siteLogoUrl : '/uploads/favicon.ico' } width={ 180 } height={ 100 } className="mx-auto mt-8 sm:w-72 sm:h-72 md:w-96 md:h-96" alt={ siteSettings?.siteName ?? 'Logo del Sitio' } />
